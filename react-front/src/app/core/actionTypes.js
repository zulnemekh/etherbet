...
export const CREATE_BET_BEGIN = "@@core/CREATE_BET_BEGIN";
export const CREATE_BET_COMPLETE = "@@core/CREATE_BET_COMPLETE";
export const CREATE_BET_ERROR = "@@core/CREATE_BET_ERROR";
